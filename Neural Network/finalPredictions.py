...
print 'Done'
print 'Training on Neural Network with',noOfFeatures,'features'
clf_NeuralNet = MLPClassifier(solver='lbfgs', alpha=1e-5,hidden_layer_sizes=(15,), random_state=1)
clf_NeuralNet.fit(tfs_train,y_train)
print 'Trained!'
print 'Predicting on the validation set'
y_validate_predict = clf_NeuralNet.predict(tfs_validate)
...
count = 0 
fileName = 'answerNN'+str(noOfFeatures)+'.csv'
print 'Predicting Values for Test Set..'
y_test_predict = clf_NeuralNet.predict(tfs_test)
