...
print 'Done'
print 'Training on NaiveBayes with',noOfFeatures,'features'
clf = MultinomialNB()
clf.fit(tfs_train, y_train)
print 'Trained!'
print 'Predicting on the validation set'
y_validate_predict = clf.predict(tfs_validate)
index = 0;
accuracy = 0
...
count = 0 
fileName = 'answerNB'+str(noOfFeatures)+'.csv'
print 'Predicting Values for Test Set..'
y_test_predict = clf.predict(tfs_test)
