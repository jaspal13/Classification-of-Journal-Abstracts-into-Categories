def cleanData():
  ...
  for i in range(a):
    ...
    if i%1000 == 0:
      print "Cleaned %s records" %(i)

  stri = ' '
  print 'Cleaning test_in.csv'
  for i in range(a1):
  ...
  print 'Done'
  print 'Files Created: train_in_clean.csv, test_in_clean.csv'
  return cleanData, cleanData1

cleanData,cleanData1 = cleanData()