0. By Running the code for K-Nearest Neighbor, generate the csv files formatted_train_in.csv and formatted_test_in.csv. This should be in the same folder as the SVM code.
